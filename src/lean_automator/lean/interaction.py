...
# import tempfile # Keep for TemporaryDirectory potentially in LSP? Now removed.
import warnings
...
try:
    ...
    ItemStatus = type(
        ...
        (object,),
        {
            "ERROR": "ERROR",
            "PROVEN": "PROVEN",
            "LEAN_VALIDATION_FAILED": "LEAN_VALIDATION_FAILED",
        },
    )  # type: ignore
...
def _module_name_to_path(module_name: str) -> pathlib.Path:
    ...
    # Reconstruct path, assume standard module naming conventions.
